    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${fieldValue(bean: questionInstance, field: 'dateCreated')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${fieldValue(bean: questionInstance, field: 'lastUpdated')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><g:link controller="survey" action="show" id="${questionInstance?.survey?.id}">${questionInstance?.survey?.encodeAsHTML()}</g:link></td>
